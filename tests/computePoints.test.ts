...
const fuzzer = () => {
    ...
    const PARAMS_RANDOM_PUBLIC_KEYS: AffineProjectivePoint[] = new Array(NUMBER_OF_TESTS).fill(0).map(generateRandomPubKey);
    ...
    /*//////////////////////////////////////////////////////////////
                                 TESTS
    //////////////////////////////////////////////////////////////*/
    it.each(PARAMS_RANDOM_PUBLIC_KEYS)('ensure the precomputed points for a given public key is on the curve',
        (pubKey) => {
