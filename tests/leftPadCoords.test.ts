...
const fuzzer = () => {
    ...
    const PARAMS_TO_TEST: [number, number][] = new Array(NUMBER_OF_TESTS).fill(0).map(generateRandomNumbers);
    ...
    /*//////////////////////////////////////////////////////////////
                                 TESTS
    //////////////////////////////////////////////////////////////*/
    it.each(PARAMS_TO_TEST)('pads a fuzzed-digit hex value with zeros', (coordinate, length) => {
        const testValueStringify = BigInt(coordinate).toString(16);
        const expectedLeadingZeros = "0".repeat(length - testValueStringify.length);
